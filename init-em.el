...
;; ps: use M-x untabify to for previous atrocitys
...
;;(set-face-background 'default "RGB:FFFF/ECF6/AB8B")
(set-face-background 'default "RGB:FFFF/EAF6/AB8B")
...
;;(set-face-background 'fringe "lightgoldenrod2")
(set-face-background 'fringe "lightgoldenrod2")
...
(custom-set-faces
 ...
 '(default ((t (:inherit nil :stipple nil :background "RGB:FFFF/EAF6/AB8B" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 90 :width normal :foundry "bitstream" :family "Bitstream Vera Sans Mono"))))
 ...
 '(font-lock-constant-face ((t (:foreground "gray44"))))
 ...
 '(fringe ((t (:background "LightGoldenrod2"))))
 ...
 '(outline-2 ((t (:foreground "lime green"))))
...
;; (add-hook 'espresso-mode-hook 'espresso-custom-setup) ;; expresso
;; (defun espresso-custom-setup ()
;;   (define-key espresso-mode-map [(meta left)] 'paredit-backward)
;;   (define-key espresso-mode-map [(meta right)] 'paredit-forward)
;;   (moz-minor-mode 1))
